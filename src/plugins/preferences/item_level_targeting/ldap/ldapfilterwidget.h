...
#ifndef GPUI_LDAP_FILTER_WIDGET_H
#define GPUI_LDAP_FILTER_WIDGET_H

#include "targetingfilterwidget.h"

QT_BEGIN_NAMESPACE
namespace Ui { class LDAPWidget; }
QT_END_NAMESPACE

namespace preferences
{

//! Editor for `<FilterLdap searchFilter=".." binding=".." variableName=".."
//! attribute=".."/>`.
class LdapFilterWidget : public TargetingFilterWidget
{
public:
    Q_OBJECT

public:
    explicit LdapFilterWidget(QWidget *parent = nullptr);
    ~LdapFilterWidget() override;

    QString xsdName() const override { return QStringLiteral("FilterLdap"); }
...
#endif // GPUI_LDAP_FILTER_WIDGET_H
