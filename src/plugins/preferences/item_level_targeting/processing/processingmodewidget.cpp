...
{
    return {
        QStringLiteral("syncFore"),  QStringLiteral("asyncFore"),
...
{
    ui->syncCheckBox->setChecked(boolFlag(extras, QStringLiteral("syncFore")));
    ui->asyncCheckBox->setChecked(boolFlag(extras, QStringLiteral("asyncFore")));
...
{
    return {
        {QStringLiteral("syncFore"),   boolStr(ui->syncCheckBox->isChecked())},
        {QStringLiteral("asyncFore"),  boolStr(ui->asyncCheckBox->isChecked())},
