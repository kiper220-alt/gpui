...
//! Editor for `<FilterTerminal>` (XSD attrs: type, option, value, min, max).
//!
//! `terminalsessionwidget.ui` swaps fields by `option` (APPLICATION /
//! PROGRAM / CLIENT / SESSION / DIRECTORY / IP / NE) and uses
//! `terminalsessiontcpwidget.ui` for the IP-range subform. The first
//! iteration round-trips attributes verbatim.
