...
/**
 * @file
 * @brief Generated from diskspacechema.xsd.
 */

#ifndef CXX_HOME_KIPER220_GITHUB_KIPER220_ALT_GPUI_SRC_PLUGINS_PREFERENCES_ITEM_LEVEL_TARGETING_SCHEMAS_DISKSPACECHEMA_H
#define CXX_HOME_KIPER220_GITHUB_KIPER220_ALT_GPUI_SRC_PLUGINS_PREFERENCES_ITEM_LEVEL_TARGETING_SCHEMAS_DISKSPACECHEMA_H
...
/**
 * @name Parsing functions for the %FilterDisk document root.
 */
//@{
 ...
 */
::std::unique_ptr< ::FilterDisk >
FilterDisk_ (const ::std::string& uri,
             ::xml_schema::Flags f = 0,
 ...
 */
::std::unique_ptr< ::FilterDisk >
FilterDisk_ (::xercesc::InputSource& is,
             ::xml_schema::Flags f = 0,
             const ::xml_schema::Properties& p = ::xml_schema::Properties ());
 ...
 */
::std::unique_ptr< ::FilterDisk >
FilterDisk_ (const ::xercesc::DOMDocument& d,
             ::xml_schema::Flags f = 0,
             const ::xml_schema::Properties& p = ::xml_schema::Properties ());
 ...
 */
::std::unique_ptr< ::FilterDisk >
FilterDisk_ (::xml_schema::dom::unique_ptr< ::xercesc::DOMDocument > d,
             ::xml_schema::Flags f = 0,
             const ::xml_schema::Properties& p = ::xml_schema::Properties ());
...
/**
 * @name Serialization functions for the %FilterDisk document root.
 */
//@{
 ...
 */
void
FilterDisk_ (::xercesc::XMLFormatTarget& ft,
             const ::FilterDisk& x, 
             const ::xml_schema::NamespaceInfomap& m = ::xml_schema::NamespaceInfomap (),
             const ::std::string& e = "UTF-8",
             ::xml_schema::Flags f = 0);
 ...
 */
void
FilterDisk_ (::xercesc::DOMDocument& d,
             const ::FilterDisk& x,
             ::xml_schema::Flags f = 0);
...
FilterDisk_ (const ::FilterDisk& x, 
             const ::xml_schema::NamespaceInfomap& m = ::xml_schema::NamespaceInfomap (),
             ::xml_schema::Flags f = 0);
...
#endif // CXX_HOME_KIPER220_GITHUB_KIPER220_ALT_GPUI_SRC_PLUGINS_PREFERENCES_ITEM_LEVEL_TARGETING_SCHEMAS_DISKSPACECHEMA_H
