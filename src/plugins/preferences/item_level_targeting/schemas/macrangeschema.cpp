...
FilterMacRange_ (const ::std::string& u,
                 ::xml_schema::Flags f,
                 const ::xml_schema::Properties& p)
{
  ...
  return ::std::unique_ptr< ::FilterMacRange > (
    ::FilterMacRange_ (
                 ...
                 const ::xml_schema::Properties& p)
{
  ...
  return ::FilterMacRange_ (isrc, f, p);
}
                 ...
                 const ::xml_schema::Properties& p)
{
  ...
  ::xsd::cxx::xml::sax::std_input_source isrc (is);
  return ::FilterMacRange_ (isrc, h, f, p);
}
...
::std::unique_ptr< ::FilterMacRange >
FilterMacRange_ (::xercesc::InputSource& i,
                 ::xml_schema::Flags f,
                 const ::xml_schema::Properties& p)
{
  ::xsd::cxx::tree::error_handler< char > h;
...
::std::unique_ptr< ::FilterMacRange >
FilterMacRange_ (const ::xercesc::DOMDocument& doc,
                 ::xml_schema::Flags f,
                 const ::xml_schema::Properties& p)
{
  ...
  if (n.name () == "FilterMacRange" &&
      n.namespace_ () == "")
  {
    ::std::unique_ptr< ::FilterMacRange > r (
      ::xsd::cxx::tree::traits< ::FilterMacRange, char >::create (
        e, f, 0));
    return r;
  }
...
void
FilterMacRange_ (::std::ostream& o,
                 const ::FilterMacRange& s,
...
void
FilterMacRange_ (::xercesc::XMLFormatTarget& t,
                 const ::FilterMacRange& s,
                 const ::xml_schema::NamespaceInfomap& m,
                 const ::std::string& e,
                 ::xml_schema::Flags f)
...
FilterMacRange_ (const ::FilterMacRange& s,
                 const ::xml_schema::NamespaceInfomap& m,
                 ::xml_schema::Flags f)
{
  ::xml_schema::dom::unique_ptr< ::xercesc::DOMDocument > d (
