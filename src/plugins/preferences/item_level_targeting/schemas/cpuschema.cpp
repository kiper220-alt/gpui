            ...
            const ::xml_schema::Properties& p)
{
  ...
  return ::std::unique_ptr< ::FilterCpu > (
    ::FilterCpu_ (
...
::std::unique_ptr< ::FilterCpu >
FilterCpu_ (::xercesc::InputSource& i,
            ::xml_schema::Flags f,
            const ::xml_schema::Properties& p)
{
  ::xsd::cxx::tree::error_handler< char > h;
...
::std::unique_ptr< ::FilterCpu >
FilterCpu_ (const ::xercesc::DOMDocument& doc,
            ::xml_schema::Flags f,
            const ::xml_schema::Properties& p)
{
  ...
  if (n.name () == "FilterCpu" &&
      n.namespace_ () == "")
  {
    ::std::unique_ptr< ::FilterCpu > r (
      ::xsd::cxx::tree::traits< ::FilterCpu, char >::create (
        e, f, 0));
    return r;
  }
...
void
FilterCpu_ (::xercesc::XMLFormatTarget& t,
            const ::FilterCpu& s,
            const ::xml_schema::NamespaceInfomap& m,
            const ::std::string& e,
            ::xml_schema::Flags f)
