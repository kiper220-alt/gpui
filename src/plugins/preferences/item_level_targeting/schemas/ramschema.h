...
/**
 * @file
 * @brief Generated from ramschema.xsd.
 */

#ifndef CXX_HOME_KIPER220_GITHUB_KIPER220_ALT_GPUI_SRC_PLUGINS_PREFERENCES_ITEM_LEVEL_TARGETING_SCHEMAS_RAMSCHEMA_H
#define CXX_HOME_KIPER220_GITHUB_KIPER220_ALT_GPUI_SRC_PLUGINS_PREFERENCES_ITEM_LEVEL_TARGETING_SCHEMAS_RAMSCHEMA_H
...
/**
 * @name Parsing functions for the %FilterRam document root.
 */
//@{
 ...
 */
::std::unique_ptr< ::FilterRam >
FilterRam_ (const ::std::string& uri,
            ::xml_schema::Flags f = 0,
 ...
 */
::std::unique_ptr< ::FilterRam >
FilterRam_ (::xercesc::InputSource& is,
            ::xml_schema::Flags f = 0,
            const ::xml_schema::Properties& p = ::xml_schema::Properties ());
 ...
 */
::std::unique_ptr< ::FilterRam >
FilterRam_ (const ::xercesc::DOMDocument& d,
            ::xml_schema::Flags f = 0,
            const ::xml_schema::Properties& p = ::xml_schema::Properties ());
 ...
 */
::std::unique_ptr< ::FilterRam >
FilterRam_ (::xml_schema::dom::unique_ptr< ::xercesc::DOMDocument > d,
            ::xml_schema::Flags f = 0,
            const ::xml_schema::Properties& p = ::xml_schema::Properties ());
...
/**
 * @name Serialization functions for the %FilterRam document root.
 */
//@{
 ...
 */
void
FilterRam_ (::xercesc::XMLFormatTarget& ft,
            const ::FilterRam& x, 
            const ::xml_schema::NamespaceInfomap& m = ::xml_schema::NamespaceInfomap (),
            const ::std::string& e = "UTF-8",
            ::xml_schema::Flags f = 0);
 ...
 */
void
FilterRam_ (::xercesc::DOMDocument& d,
            const ::FilterRam& x,
            ::xml_schema::Flags f = 0);
...
#endif // CXX_HOME_KIPER220_GITHUB_KIPER220_ALT_GPUI_SRC_PLUGINS_PREFERENCES_ITEM_LEVEL_TARGETING_SCHEMAS_RAMSCHEMA_H
