...
FilterUser_ (const ::std::string& u,
             ::xml_schema::Flags f,
             const ::xml_schema::Properties& p)
{
  ...
  return ::std::unique_ptr< ::FilterUser > (
    ::FilterUser_ (
...
::std::unique_ptr< ::FilterUser >
FilterUser_ (::xercesc::InputSource& i,
             ::xml_schema::Flags f,
             const ::xml_schema::Properties& p)
{
  ::xsd::cxx::tree::error_handler< char > h;
...
::std::unique_ptr< ::FilterUser >
FilterUser_ (const ::xercesc::DOMDocument& doc,
             ::xml_schema::Flags f,
             const ::xml_schema::Properties& p)
{
  ...
  if (n.name () == "FilterUser" &&
      n.namespace_ () == "")
  {
    ::std::unique_ptr< ::FilterUser > r (
      ::xsd::cxx::tree::traits< ::FilterUser, char >::create (
        e, f, 0));
    return r;
  }
...
void
FilterUser_ (::xercesc::XMLFormatTarget& t,
             const ::FilterUser& s,
             const ::xml_schema::NamespaceInfomap& m,
             const ::std::string& e,
             ::xml_schema::Flags f)
...
FilterUser_ (const ::FilterUser& s,
             const ::xml_schema::NamespaceInfomap& m,
             ::xml_schema::Flags f)
{
  ::xml_schema::dom::unique_ptr< ::xercesc::DOMDocument > d (
