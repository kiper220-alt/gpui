...
FilterOrgUnit_ (const ::std::string& u,
                ::xml_schema::Flags f,
                const ::xml_schema::Properties& p)
{
  ...
  return ::std::unique_ptr< ::FilterOrgUnit > (
    ::FilterOrgUnit_ (
                ...
                const ::xml_schema::Properties& p)
{
  ...
  return ::FilterOrgUnit_ (isrc, f, p);
}
                ...
                const ::xml_schema::Properties& p)
{
  ...
  ::xsd::cxx::xml::sax::std_input_source isrc (is);
  return ::FilterOrgUnit_ (isrc, h, f, p);
}
...
::std::unique_ptr< ::FilterOrgUnit >
FilterOrgUnit_ (::xercesc::InputSource& i,
                ::xml_schema::Flags f,
                const ::xml_schema::Properties& p)
{
  ::xsd::cxx::tree::error_handler< char > h;
...
::std::unique_ptr< ::FilterOrgUnit >
FilterOrgUnit_ (const ::xercesc::DOMDocument& doc,
                ::xml_schema::Flags f,
                const ::xml_schema::Properties& p)
{
  ...
  if (n.name () == "FilterOrgUnit" &&
      n.namespace_ () == "")
  {
    ::std::unique_ptr< ::FilterOrgUnit > r (
      ::xsd::cxx::tree::traits< ::FilterOrgUnit, char >::create (
        e, f, 0));
    return r;
  }
...
void
FilterOrgUnit_ (::std::ostream& o,
                const ::FilterOrgUnit& s,
...
void
FilterOrgUnit_ (::xercesc::XMLFormatTarget& t,
                const ::FilterOrgUnit& s,
                const ::xml_schema::NamespaceInfomap& m,
                const ::std::string& e,
                ::xml_schema::Flags f)
...
FilterOrgUnit_ (const ::FilterOrgUnit& s,
                const ::xml_schema::NamespaceInfomap& m,
                ::xml_schema::Flags f)
{
  ::xml_schema::dom::unique_ptr< ::xercesc::DOMDocument > d (
