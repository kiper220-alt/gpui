            ...
            const ::xml_schema::Properties& p)
{
  ...
  return ::std::unique_ptr< ::FilterDun > (
    ::FilterDun_ (
...
::std::unique_ptr< ::FilterDun >
FilterDun_ (::xercesc::InputSource& i,
            ::xml_schema::Flags f,
            const ::xml_schema::Properties& p)
{
  ::xsd::cxx::tree::error_handler< char > h;
...
::std::unique_ptr< ::FilterDun >
FilterDun_ (const ::xercesc::DOMDocument& doc,
            ::xml_schema::Flags f,
            const ::xml_schema::Properties& p)
{
  ...
  if (n.name () == "FilterDun" &&
      n.namespace_ () == "")
  {
    ::std::unique_ptr< ::FilterDun > r (
      ::xsd::cxx::tree::traits< ::FilterDun, char >::create (
        e, f, 0));
    return r;
  }
...
void
FilterDun_ (::xercesc::XMLFormatTarget& t,
            const ::FilterDun& s,
            const ::xml_schema::NamespaceInfomap& m,
            const ::std::string& e,
            ::xml_schema::Flags f)
