...
/**
 * @file
 * @brief Generated from portableschema.xsd.
 */

#ifndef CXX_HOME_KIPER220_GITHUB_KIPER220_ALT_GPUI_SRC_PLUGINS_PREFERENCES_ITEM_LEVEL_TARGETING_SCHEMAS_PORTABLESCHEMA_H
#define CXX_HOME_KIPER220_GITHUB_KIPER220_ALT_GPUI_SRC_PLUGINS_PREFERENCES_ITEM_LEVEL_TARGETING_SCHEMAS_PORTABLESCHEMA_H
...
/**
 * @name Parsing functions for the %FilterPortable document root.
 */
//@{
...
FilterPortable_ (const ::std::string& uri,
                 ::xml_schema::Flags f = 0,
 ...
 */
::std::unique_ptr< ::FilterPortable >
FilterPortable_ (::xercesc::InputSource& is,
                 ::xml_schema::Flags f = 0,
                 const ::xml_schema::Properties& p = ::xml_schema::Properties ());
 ...
 */
::std::unique_ptr< ::FilterPortable >
FilterPortable_ (const ::xercesc::DOMDocument& d,
                 ::xml_schema::Flags f = 0,
                 const ::xml_schema::Properties& p = ::xml_schema::Properties ());
...
/**
 * @name Serialization functions for the %FilterPortable document root.
 */
//@{
 ...
 */
void
FilterPortable_ (::std::ostream& os,
                 const ::FilterPortable& x, 
 ...
 */
void
FilterPortable_ (::xercesc::XMLFormatTarget& ft,
                 const ::FilterPortable& x, 
                 const ::xml_schema::NamespaceInfomap& m = ::xml_schema::NamespaceInfomap (),
                 const ::std::string& e = "UTF-8",
                 ::xml_schema::Flags f = 0);
...
FilterPortable_ (const ::FilterPortable& x, 
                 const ::xml_schema::NamespaceInfomap& m = ::xml_schema::NamespaceInfomap (),
                 ::xml_schema::Flags f = 0);
...
#endif // CXX_HOME_KIPER220_GITHUB_KIPER220_ALT_GPUI_SRC_PLUGINS_PREFERENCES_ITEM_LEVEL_TARGETING_SCHEMAS_PORTABLESCHEMA_H
