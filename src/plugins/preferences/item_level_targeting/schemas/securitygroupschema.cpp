...
FilterGroup_ (const ::std::string& u,
              ::xml_schema::Flags f,
              const ::xml_schema::Properties& p)
{
  ...
  return ::std::unique_ptr< ::FilterGroup > (
    ::FilterGroup_ (
              ...
              const ::xml_schema::Properties& p)
{
  ...
  ::xsd::cxx::xml::sax::std_input_source isrc (is);
  return ::FilterGroup_ (isrc, h, f, p);
}
...
::std::unique_ptr< ::FilterGroup >
FilterGroup_ (::xercesc::InputSource& i,
              ::xml_schema::Flags f,
              const ::xml_schema::Properties& p)
{
  ::xsd::cxx::tree::error_handler< char > h;
...
::std::unique_ptr< ::FilterGroup >
FilterGroup_ (const ::xercesc::DOMDocument& doc,
              ::xml_schema::Flags f,
              const ::xml_schema::Properties& p)
{
  ...
  if (n.name () == "FilterGroup" &&
      n.namespace_ () == "")
  {
    ::std::unique_ptr< ::FilterGroup > r (
      ::xsd::cxx::tree::traits< ::FilterGroup, char >::create (
        e, f, 0));
    return r;
  }
...
void
FilterGroup_ (::xercesc::XMLFormatTarget& t,
              const ::FilterGroup& s,
              const ::xml_schema::NamespaceInfomap& m,
              const ::std::string& e,
              ::xml_schema::Flags f)
...
FilterGroup_ (const ::FilterGroup& s,
              const ::xml_schema::NamespaceInfomap& m,
              ::xml_schema::Flags f)
{
  ::xml_schema::dom::unique_ptr< ::xercesc::DOMDocument > d (
