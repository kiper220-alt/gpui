...
FilterPcmcia_ (const ::std::string& u,
               ::xml_schema::Flags f,
               const ::xml_schema::Properties& p)
{
  ...
  return ::std::unique_ptr< ::FilterPcmcia > (
    ::FilterPcmcia_ (
               ...
               const ::xml_schema::Properties& p)
{
  ...
  ::xsd::cxx::xml::sax::std_input_source isrc (is);
  return ::FilterPcmcia_ (isrc, h, f, p);
}
...
::std::unique_ptr< ::FilterPcmcia >
FilterPcmcia_ (::xercesc::InputSource& i,
               ::xml_schema::Flags f,
               const ::xml_schema::Properties& p)
{
  ::xsd::cxx::tree::error_handler< char > h;
...
::std::unique_ptr< ::FilterPcmcia >
FilterPcmcia_ (const ::xercesc::DOMDocument& doc,
               ::xml_schema::Flags f,
               const ::xml_schema::Properties& p)
{
  ...
  if (n.name () == "FilterPcmcia" &&
      n.namespace_ () == "")
  {
    ::std::unique_ptr< ::FilterPcmcia > r (
      ::xsd::cxx::tree::traits< ::FilterPcmcia, char >::create (
        e, f, 0));
    return r;
  }
...
void
FilterPcmcia_ (::std::ostream& o,
               const ::FilterPcmcia& s,
...
void
FilterPcmcia_ (::xercesc::XMLFormatTarget& t,
               const ::FilterPcmcia& s,
               const ::xml_schema::NamespaceInfomap& m,
               const ::std::string& e,
               ::xml_schema::Flags f)
...
FilterPcmcia_ (const ::FilterPcmcia& s,
               const ::xml_schema::NamespaceInfomap& m,
               ::xml_schema::Flags f)
{
  ::xml_schema::dom::unique_ptr< ::xercesc::DOMDocument > d (
