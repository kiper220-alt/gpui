            ...
            const ::xml_schema::Properties& p)
{
  ...
  return ::std::unique_ptr< ::FilterRam > (
    ::FilterRam_ (
...
::std::unique_ptr< ::FilterRam >
FilterRam_ (::xercesc::InputSource& i,
            ::xml_schema::Flags f,
            const ::xml_schema::Properties& p)
{
  ::xsd::cxx::tree::error_handler< char > h;
...
::std::unique_ptr< ::FilterRam >
FilterRam_ (const ::xercesc::DOMDocument& doc,
            ::xml_schema::Flags f,
            const ::xml_schema::Properties& p)
{
  ...
  if (n.name () == "FilterRam" &&
      n.namespace_ () == "")
  {
    ::std::unique_ptr< ::FilterRam > r (
      ::xsd::cxx::tree::traits< ::FilterRam, char >::create (
        e, f, 0));
    return r;
  }
...
void
FilterRam_ (::xercesc::XMLFormatTarget& t,
            const ::FilterRam& s,
            const ::xml_schema::NamespaceInfomap& m,
            const ::std::string& e,
            ::xml_schema::Flags f)
