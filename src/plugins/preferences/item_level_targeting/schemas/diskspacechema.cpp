...
FilterDisk_ (const ::std::string& u,
             ::xml_schema::Flags f,
             const ::xml_schema::Properties& p)
{
  ...
  return ::std::unique_ptr< ::FilterDisk > (
    ::FilterDisk_ (
...
::std::unique_ptr< ::FilterDisk >
FilterDisk_ (::xercesc::InputSource& i,
             ::xml_schema::Flags f,
             const ::xml_schema::Properties& p)
{
  ::xsd::cxx::tree::error_handler< char > h;
...
::std::unique_ptr< ::FilterDisk >
FilterDisk_ (const ::xercesc::DOMDocument& doc,
             ::xml_schema::Flags f,
             const ::xml_schema::Properties& p)
{
  ...
  if (n.name () == "FilterDisk" &&
      n.namespace_ () == "")
  {
    ::std::unique_ptr< ::FilterDisk > r (
      ::xsd::cxx::tree::traits< ::FilterDisk, char >::create (
        e, f, 0));
    return r;
  }
...
void
FilterDisk_ (::xercesc::XMLFormatTarget& t,
             const ::FilterDisk& s,
             const ::xml_schema::NamespaceInfomap& m,
             const ::std::string& e,
             ::xml_schema::Flags f)
...
FilterDisk_ (const ::FilterDisk& s,
             const ::xml_schema::NamespaceInfomap& m,
             ::xml_schema::Flags f)
{
  ::xml_schema::dom::unique_ptr< ::xercesc::DOMDocument > d (
