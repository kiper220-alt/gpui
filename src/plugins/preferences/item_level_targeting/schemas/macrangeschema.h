...
/**
 * @file
 * @brief Generated from macrangeschema.xsd.
 */

#ifndef CXX_HOME_KIPER220_GITHUB_KIPER220_ALT_GPUI_SRC_PLUGINS_PREFERENCES_ITEM_LEVEL_TARGETING_SCHEMAS_MACRANGESCHEMA_H
#define CXX_HOME_KIPER220_GITHUB_KIPER220_ALT_GPUI_SRC_PLUGINS_PREFERENCES_ITEM_LEVEL_TARGETING_SCHEMAS_MACRANGESCHEMA_H
...
/**
 * @name Parsing functions for the %FilterMacRange document root.
 */
//@{
 ...
 */
::std::unique_ptr< ::FilterMacRange >
FilterMacRange_ (const ::std::string& uri,
                 ::xml_schema::Flags f = 0,
 ...
 */
::std::unique_ptr< ::FilterMacRange >
FilterMacRange_ (::std::istream& is,
                 ::xml_schema::Flags f = 0,
                 const ::xml_schema::Properties& p = ::xml_schema::Properties ());
 ...
 */
::std::unique_ptr< ::FilterMacRange >
FilterMacRange_ (::xercesc::InputSource& is,
                 ::xml_schema::Flags f = 0,
                 const ::xml_schema::Properties& p = ::xml_schema::Properties ());
 ...
 */
::std::unique_ptr< ::FilterMacRange >
FilterMacRange_ (const ::xercesc::DOMDocument& d,
                 ::xml_schema::Flags f = 0,
                 const ::xml_schema::Properties& p = ::xml_schema::Properties ());
 ...
 */
::std::unique_ptr< ::FilterMacRange >
FilterMacRange_ (::xml_schema::dom::unique_ptr< ::xercesc::DOMDocument > d,
                 ::xml_schema::Flags f = 0,
                 const ::xml_schema::Properties& p = ::xml_schema::Properties ());
...
/**
 * @name Serialization functions for the %FilterMacRange document root.
 */
//@{
 ...
 */
void
FilterMacRange_ (::std::ostream& os,
                 const ::FilterMacRange& x, 
 ...
 */
void
FilterMacRange_ (::xercesc::XMLFormatTarget& ft,
                 const ::FilterMacRange& x, 
                 const ::xml_schema::NamespaceInfomap& m = ::xml_schema::NamespaceInfomap (),
                 const ::std::string& e = "UTF-8",
                 ::xml_schema::Flags f = 0);
 ...
 */
void
FilterMacRange_ (::xercesc::DOMDocument& d,
                 const ::FilterMacRange& x,
                 ::xml_schema::Flags f = 0);
...
FilterMacRange_ (const ::FilterMacRange& x, 
                 const ::xml_schema::NamespaceInfomap& m = ::xml_schema::NamespaceInfomap (),
                 ::xml_schema::Flags f = 0);
...
#endif // CXX_HOME_KIPER220_GITHUB_KIPER220_ALT_GPUI_SRC_PLUGINS_PREFERENCES_ITEM_LEVEL_TARGETING_SCHEMAS_MACRANGESCHEMA_H
