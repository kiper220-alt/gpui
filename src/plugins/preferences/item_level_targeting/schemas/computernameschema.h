...
/**
 * @file
 * @brief Generated from computernameschema.xsd.
 */

#ifndef CXX_HOME_KIPER220_GITHUB_KIPER220_ALT_GPUI_SRC_PLUGINS_PREFERENCES_ITEM_LEVEL_TARGETING_SCHEMAS_COMPUTERNAMESCHEMA_H
#define CXX_HOME_KIPER220_GITHUB_KIPER220_ALT_GPUI_SRC_PLUGINS_PREFERENCES_ITEM_LEVEL_TARGETING_SCHEMAS_COMPUTERNAMESCHEMA_H
...
/**
 * @name Parsing functions for the %FilterComputer document root.
 */
//@{
 ...
 */
::std::unique_ptr< ::FilterComputer >
FilterComputer_ (const ::std::string& uri,
                 ::xml_schema::Flags f = 0,
 ...
 */
::std::unique_ptr< ::FilterComputer >
FilterComputer_ (::std::istream& is,
                 ::xml_schema::Flags f = 0,
                 const ::xml_schema::Properties& p = ::xml_schema::Properties ());
 ...
 */
::std::unique_ptr< ::FilterComputer >
FilterComputer_ (::xercesc::InputSource& is,
                 ::xml_schema::Flags f = 0,
                 const ::xml_schema::Properties& p = ::xml_schema::Properties ());
 ...
 */
::std::unique_ptr< ::FilterComputer >
FilterComputer_ (const ::xercesc::DOMDocument& d,
                 ::xml_schema::Flags f = 0,
                 const ::xml_schema::Properties& p = ::xml_schema::Properties ());
 ...
 */
::std::unique_ptr< ::FilterComputer >
FilterComputer_ (::xml_schema::dom::unique_ptr< ::xercesc::DOMDocument > d,
                 ::xml_schema::Flags f = 0,
                 const ::xml_schema::Properties& p = ::xml_schema::Properties ());
...
/**
 * @name Serialization functions for the %FilterComputer document root.
 */
//@{
 ...
 */
void
FilterComputer_ (::std::ostream& os,
                 const ::FilterComputer& x, 
 ...
 */
void
FilterComputer_ (::xercesc::XMLFormatTarget& ft,
                 const ::FilterComputer& x, 
                 const ::xml_schema::NamespaceInfomap& m = ::xml_schema::NamespaceInfomap (),
                 const ::std::string& e = "UTF-8",
                 ::xml_schema::Flags f = 0);
 ...
 */
void
FilterComputer_ (::xercesc::DOMDocument& d,
                 const ::FilterComputer& x,
                 ::xml_schema::Flags f = 0);
...
FilterComputer_ (const ::FilterComputer& x, 
                 const ::xml_schema::NamespaceInfomap& m = ::xml_schema::NamespaceInfomap (),
                 ::xml_schema::Flags f = 0);
...
#endif // CXX_HOME_KIPER220_GITHUB_KIPER220_ALT_GPUI_SRC_PLUGINS_PREFERENCES_ITEM_LEVEL_TARGETING_SCHEMAS_COMPUTERNAMESCHEMA_H
