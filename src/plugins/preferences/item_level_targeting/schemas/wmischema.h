...
/**
 * @file
 * @brief Generated from wmischema.xsd.
 */

#ifndef CXX_HOME_KIPER220_GITHUB_KIPER220_ALT_GPUI_SRC_PLUGINS_PREFERENCES_ITEM_LEVEL_TARGETING_SCHEMAS_WMISCHEMA_H
#define CXX_HOME_KIPER220_GITHUB_KIPER220_ALT_GPUI_SRC_PLUGINS_PREFERENCES_ITEM_LEVEL_TARGETING_SCHEMAS_WMISCHEMA_H
...
/**
 * @name Parsing functions for the %FilterWmi document root.
 */
//@{
...
FilterWmi_ (const ::std::string& uri,
            ::xml_schema::Flags f = 0,
 ...
 */
::std::unique_ptr< ::FilterWmi >
FilterWmi_ (::xercesc::InputSource& is,
            ::xml_schema::Flags f = 0,
            const ::xml_schema::Properties& p = ::xml_schema::Properties ());
 ...
 */
::std::unique_ptr< ::FilterWmi >
FilterWmi_ (const ::xercesc::DOMDocument& d,
            ::xml_schema::Flags f = 0,
            const ::xml_schema::Properties& p = ::xml_schema::Properties ());
...
/**
 * @name Serialization functions for the %FilterWmi document root.
 */
//@{
 ...
 */
void
FilterWmi_ (::xercesc::XMLFormatTarget& ft,
            const ::FilterWmi& x, 
            const ::xml_schema::NamespaceInfomap& m = ::xml_schema::NamespaceInfomap (),
            const ::std::string& e = "UTF-8",
            ::xml_schema::Flags f = 0);
...
#endif // CXX_HOME_KIPER220_GITHUB_KIPER220_ALT_GPUI_SRC_PLUGINS_PREFERENCES_ITEM_LEVEL_TARGETING_SCHEMAS_WMISCHEMA_H
