...
/**
 * @file
 * @brief Generated from siteschema.xsd.
 */

#ifndef CXX_HOME_KIPER220_GITHUB_KIPER220_ALT_GPUI_SRC_PLUGINS_PREFERENCES_ITEM_LEVEL_TARGETING_SCHEMAS_SITESCHEMA_H
#define CXX_HOME_KIPER220_GITHUB_KIPER220_ALT_GPUI_SRC_PLUGINS_PREFERENCES_ITEM_LEVEL_TARGETING_SCHEMAS_SITESCHEMA_H
...
/**
 * @name Parsing functions for the %FilterSite document root.
 */
//@{
 ...
 */
::std::unique_ptr< ::FilterSite >
FilterSite_ (const ::std::string& uri,
             ::xml_schema::Flags f = 0,
 ...
 */
::std::unique_ptr< ::FilterSite >
FilterSite_ (::xercesc::InputSource& is,
             ::xml_schema::Flags f = 0,
             const ::xml_schema::Properties& p = ::xml_schema::Properties ());
 ...
 */
::std::unique_ptr< ::FilterSite >
FilterSite_ (const ::xercesc::DOMDocument& d,
             ::xml_schema::Flags f = 0,
             const ::xml_schema::Properties& p = ::xml_schema::Properties ());
 ...
 */
::std::unique_ptr< ::FilterSite >
FilterSite_ (::xml_schema::dom::unique_ptr< ::xercesc::DOMDocument > d,
             ::xml_schema::Flags f = 0,
             const ::xml_schema::Properties& p = ::xml_schema::Properties ());
...
/**
 * @name Serialization functions for the %FilterSite document root.
 */
//@{
 ...
 */
void
FilterSite_ (::xercesc::XMLFormatTarget& ft,
             const ::FilterSite& x, 
             const ::xml_schema::NamespaceInfomap& m = ::xml_schema::NamespaceInfomap (),
             const ::std::string& e = "UTF-8",
             ::xml_schema::Flags f = 0);
 ...
 */
void
FilterSite_ (::xercesc::DOMDocument& d,
             const ::FilterSite& x,
             ::xml_schema::Flags f = 0);
...
FilterSite_ (const ::FilterSite& x, 
             const ::xml_schema::NamespaceInfomap& m = ::xml_schema::NamespaceInfomap (),
             ::xml_schema::Flags f = 0);
...
#endif // CXX_HOME_KIPER220_GITHUB_KIPER220_ALT_GPUI_SRC_PLUGINS_PREFERENCES_ITEM_LEVEL_TARGETING_SCHEMAS_SITESCHEMA_H
