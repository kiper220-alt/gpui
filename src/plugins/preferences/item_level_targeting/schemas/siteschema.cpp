...
FilterSite_ (const ::std::string& u,
             ::xml_schema::Flags f,
             const ::xml_schema::Properties& p)
{
  ...
  return ::std::unique_ptr< ::FilterSite > (
    ::FilterSite_ (
...
::std::unique_ptr< ::FilterSite >
FilterSite_ (::xercesc::InputSource& i,
             ::xml_schema::Flags f,
             const ::xml_schema::Properties& p)
{
  ::xsd::cxx::tree::error_handler< char > h;
...
::std::unique_ptr< ::FilterSite >
FilterSite_ (const ::xercesc::DOMDocument& doc,
             ::xml_schema::Flags f,
             const ::xml_schema::Properties& p)
{
  ...
  if (n.name () == "FilterSite" &&
      n.namespace_ () == "")
  {
    ::std::unique_ptr< ::FilterSite > r (
      ::xsd::cxx::tree::traits< ::FilterSite, char >::create (
        e, f, 0));
    return r;
  }
...
void
FilterSite_ (::xercesc::XMLFormatTarget& t,
             const ::FilterSite& s,
             const ::xml_schema::NamespaceInfomap& m,
             const ::std::string& e,
             ::xml_schema::Flags f)
...
FilterSite_ (const ::FilterSite& s,
             const ::xml_schema::NamespaceInfomap& m,
             ::xml_schema::Flags f)
{
  ::xml_schema::dom::unique_ptr< ::xercesc::DOMDocument > d (
