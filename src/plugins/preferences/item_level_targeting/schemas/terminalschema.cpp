...
FilterTerminal_ (const ::std::string& u,
                 ::xml_schema::Flags f,
                 const ::xml_schema::Properties& p)
{
  ...
  return ::std::unique_ptr< ::FilterTerminal > (
    ::FilterTerminal_ (
                 ...
                 const ::xml_schema::Properties& p)
{
  ...
  return ::FilterTerminal_ (isrc, f, p);
}
                 ...
                 const ::xml_schema::Properties& p)
{
  ...
  ::xsd::cxx::xml::sax::std_input_source isrc (is);
  return ::FilterTerminal_ (isrc, h, f, p);
}
...
::std::unique_ptr< ::FilterTerminal >
FilterTerminal_ (::xercesc::InputSource& i,
                 ::xml_schema::Flags f,
                 const ::xml_schema::Properties& p)
{
  ::xsd::cxx::tree::error_handler< char > h;
...
::std::unique_ptr< ::FilterTerminal >
FilterTerminal_ (const ::xercesc::DOMDocument& doc,
                 ::xml_schema::Flags f,
                 const ::xml_schema::Properties& p)
{
  ...
  if (n.name () == "FilterTerminal" &&
      n.namespace_ () == "")
  {
    ::std::unique_ptr< ::FilterTerminal > r (
      ::xsd::cxx::tree::traits< ::FilterTerminal, char >::create (
        e, f, 0));
    return r;
  }
...
void
FilterTerminal_ (::std::ostream& o,
                 const ::FilterTerminal& s,
...
void
FilterTerminal_ (::xercesc::XMLFormatTarget& t,
                 const ::FilterTerminal& s,
                 const ::xml_schema::NamespaceInfomap& m,
                 const ::std::string& e,
                 ::xml_schema::Flags f)
...
FilterTerminal_ (const ::FilterTerminal& s,
                 const ::xml_schema::NamespaceInfomap& m,
                 ::xml_schema::Flags f)
{
  ::xml_schema::dom::unique_ptr< ::xercesc::DOMDocument > d (
