...
/**
 * @file
 * @brief Generated from securitygroupschema.xsd.
 */

#ifndef CXX_HOME_KIPER220_GITHUB_KIPER220_ALT_GPUI_SRC_PLUGINS_PREFERENCES_ITEM_LEVEL_TARGETING_SCHEMAS_SECURITYGROUPSCHEMA_H
#define CXX_HOME_KIPER220_GITHUB_KIPER220_ALT_GPUI_SRC_PLUGINS_PREFERENCES_ITEM_LEVEL_TARGETING_SCHEMAS_SECURITYGROUPSCHEMA_H
...
/**
 * @name Parsing functions for the %FilterGroup document root.
 */
//@{
 ...
 */
::std::unique_ptr< ::FilterGroup >
FilterGroup_ (const ::std::string& uri,
              ::xml_schema::Flags f = 0,
 ...
 */
::std::unique_ptr< ::FilterGroup >
FilterGroup_ (::xercesc::InputSource& is,
              ::xml_schema::Flags f = 0,
              const ::xml_schema::Properties& p = ::xml_schema::Properties ());
 ...
 */
::std::unique_ptr< ::FilterGroup >
FilterGroup_ (const ::xercesc::DOMDocument& d,
              ::xml_schema::Flags f = 0,
              const ::xml_schema::Properties& p = ::xml_schema::Properties ());
 ...
 */
::std::unique_ptr< ::FilterGroup >
FilterGroup_ (::xml_schema::dom::unique_ptr< ::xercesc::DOMDocument > d,
              ::xml_schema::Flags f = 0,
              const ::xml_schema::Properties& p = ::xml_schema::Properties ());
...
/**
 * @name Serialization functions for the %FilterGroup document root.
 */
//@{
 ...
 */
void
FilterGroup_ (::xercesc::XMLFormatTarget& ft,
              const ::FilterGroup& x, 
              const ::xml_schema::NamespaceInfomap& m = ::xml_schema::NamespaceInfomap (),
              const ::std::string& e = "UTF-8",
              ::xml_schema::Flags f = 0);
 ...
 */
void
FilterGroup_ (::xercesc::DOMDocument& d,
              const ::FilterGroup& x,
              ::xml_schema::Flags f = 0);
...
FilterGroup_ (const ::FilterGroup& x, 
              const ::xml_schema::NamespaceInfomap& m = ::xml_schema::NamespaceInfomap (),
              ::xml_schema::Flags f = 0);
...
#endif // CXX_HOME_KIPER220_GITHUB_KIPER220_ALT_GPUI_SRC_PLUGINS_PREFERENCES_ITEM_LEVEL_TARGETING_SCHEMAS_SECURITYGROUPSCHEMA_H
