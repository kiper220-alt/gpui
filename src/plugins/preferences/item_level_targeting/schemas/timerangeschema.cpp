...
FilterTime_ (const ::std::string& u,
             ::xml_schema::Flags f,
             const ::xml_schema::Properties& p)
{
  ...
  return ::std::unique_ptr< ::FilterTime > (
    ::FilterTime_ (
...
::std::unique_ptr< ::FilterTime >
FilterTime_ (::xercesc::InputSource& i,
             ::xml_schema::Flags f,
             const ::xml_schema::Properties& p)
{
  ::xsd::cxx::tree::error_handler< char > h;
...
::std::unique_ptr< ::FilterTime >
FilterTime_ (const ::xercesc::DOMDocument& doc,
             ::xml_schema::Flags f,
             const ::xml_schema::Properties& p)
{
  ...
  if (n.name () == "FilterTime" &&
      n.namespace_ () == "")
  {
    ::std::unique_ptr< ::FilterTime > r (
      ::xsd::cxx::tree::traits< ::FilterTime, char >::create (
        e, f, 0));
    return r;
  }
...
void
FilterTime_ (::xercesc::XMLFormatTarget& t,
             const ::FilterTime& s,
             const ::xml_schema::NamespaceInfomap& m,
             const ::std::string& e,
             ::xml_schema::Flags f)
...
FilterTime_ (const ::FilterTime& s,
             const ::xml_schema::NamespaceInfomap& m,
             ::xml_schema::Flags f)
{
  ::xml_schema::dom::unique_ptr< ::xercesc::DOMDocument > d (
