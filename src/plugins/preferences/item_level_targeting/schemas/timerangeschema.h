...
/**
 * @file
 * @brief Generated from timerangeschema.xsd.
 */

#ifndef CXX_HOME_KIPER220_GITHUB_KIPER220_ALT_GPUI_SRC_PLUGINS_PREFERENCES_ITEM_LEVEL_TARGETING_SCHEMAS_TIMERANGESCHEMA_H
#define CXX_HOME_KIPER220_GITHUB_KIPER220_ALT_GPUI_SRC_PLUGINS_PREFERENCES_ITEM_LEVEL_TARGETING_SCHEMAS_TIMERANGESCHEMA_H
...
/**
 * @name Parsing functions for the %FilterTime document root.
 */
//@{
 ...
 */
::std::unique_ptr< ::FilterTime >
FilterTime_ (const ::std::string& uri,
             ::xml_schema::Flags f = 0,
 ...
 */
::std::unique_ptr< ::FilterTime >
FilterTime_ (::xercesc::InputSource& is,
             ::xml_schema::Flags f = 0,
             const ::xml_schema::Properties& p = ::xml_schema::Properties ());
 ...
 */
::std::unique_ptr< ::FilterTime >
FilterTime_ (const ::xercesc::DOMDocument& d,
             ::xml_schema::Flags f = 0,
             const ::xml_schema::Properties& p = ::xml_schema::Properties ());
 ...
 */
::std::unique_ptr< ::FilterTime >
FilterTime_ (::xml_schema::dom::unique_ptr< ::xercesc::DOMDocument > d,
             ::xml_schema::Flags f = 0,
             const ::xml_schema::Properties& p = ::xml_schema::Properties ());
...
/**
 * @name Serialization functions for the %FilterTime document root.
 */
//@{
 ...
 */
void
FilterTime_ (::xercesc::XMLFormatTarget& ft,
             const ::FilterTime& x, 
             const ::xml_schema::NamespaceInfomap& m = ::xml_schema::NamespaceInfomap (),
             const ::std::string& e = "UTF-8",
             ::xml_schema::Flags f = 0);
 ...
 */
void
FilterTime_ (::xercesc::DOMDocument& d,
             const ::FilterTime& x,
             ::xml_schema::Flags f = 0);
...
FilterTime_ (const ::FilterTime& x, 
             const ::xml_schema::NamespaceInfomap& m = ::xml_schema::NamespaceInfomap (),
             ::xml_schema::Flags f = 0);
...
#endif // CXX_HOME_KIPER220_GITHUB_KIPER220_ALT_GPUI_SRC_PLUGINS_PREFERENCES_ITEM_LEVEL_TARGETING_SCHEMAS_TIMERANGESCHEMA_H
