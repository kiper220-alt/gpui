...
FilterComputer_ (const ::std::string& u,
                 ::xml_schema::Flags f,
                 const ::xml_schema::Properties& p)
{
  ...
  return ::std::unique_ptr< ::FilterComputer > (
    ::FilterComputer_ (
                 ...
                 const ::xml_schema::Properties& p)
{
  ...
  return ::FilterComputer_ (isrc, f, p);
}
                 ...
                 const ::xml_schema::Properties& p)
{
  ...
  ::xsd::cxx::xml::sax::std_input_source isrc (is);
  return ::FilterComputer_ (isrc, h, f, p);
}
...
::std::unique_ptr< ::FilterComputer >
FilterComputer_ (::xercesc::InputSource& i,
                 ::xml_schema::Flags f,
                 const ::xml_schema::Properties& p)
{
  ::xsd::cxx::tree::error_handler< char > h;
...
::std::unique_ptr< ::FilterComputer >
FilterComputer_ (const ::xercesc::DOMDocument& doc,
                 ::xml_schema::Flags f,
                 const ::xml_schema::Properties& p)
{
  ...
  if (n.name () == "FilterComputer" &&
      n.namespace_ () == "")
  {
    ::std::unique_ptr< ::FilterComputer > r (
      ::xsd::cxx::tree::traits< ::FilterComputer, char >::create (
        e, f, 0));
    return r;
  }
...
void
FilterComputer_ (::std::ostream& o,
                 const ::FilterComputer& s,
...
void
FilterComputer_ (::xercesc::XMLFormatTarget& t,
                 const ::FilterComputer& s,
                 const ::xml_schema::NamespaceInfomap& m,
                 const ::std::string& e,
                 ::xml_schema::Flags f)
...
FilterComputer_ (const ::FilterComputer& s,
                 const ::xml_schema::NamespaceInfomap& m,
                 ::xml_schema::Flags f)
{
  ::xml_schema::dom::unique_ptr< ::xercesc::DOMDocument > d (
