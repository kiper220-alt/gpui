...
/**
 * @file
 * @brief Generated from cpuschema.xsd.
 */

#ifndef CXX_HOME_KIPER220_GITHUB_KIPER220_ALT_GPUI_SRC_PLUGINS_PREFERENCES_ITEM_LEVEL_TARGETING_SCHEMAS_CPUSCHEMA_H
#define CXX_HOME_KIPER220_GITHUB_KIPER220_ALT_GPUI_SRC_PLUGINS_PREFERENCES_ITEM_LEVEL_TARGETING_SCHEMAS_CPUSCHEMA_H
...
/**
 * @name Parsing functions for the %FilterCpu document root.
 */
//@{
 ...
 */
::std::unique_ptr< ::FilterCpu >
FilterCpu_ (const ::std::string& uri,
            ::xml_schema::Flags f = 0,
 ...
 */
::std::unique_ptr< ::FilterCpu >
FilterCpu_ (::xercesc::InputSource& is,
            ::xml_schema::Flags f = 0,
            const ::xml_schema::Properties& p = ::xml_schema::Properties ());
 ...
 */
::std::unique_ptr< ::FilterCpu >
FilterCpu_ (const ::xercesc::DOMDocument& d,
            ::xml_schema::Flags f = 0,
            const ::xml_schema::Properties& p = ::xml_schema::Properties ());
 ...
 */
::std::unique_ptr< ::FilterCpu >
FilterCpu_ (::xml_schema::dom::unique_ptr< ::xercesc::DOMDocument > d,
            ::xml_schema::Flags f = 0,
            const ::xml_schema::Properties& p = ::xml_schema::Properties ());
...
/**
 * @name Serialization functions for the %FilterCpu document root.
 */
//@{
 ...
 */
void
FilterCpu_ (::xercesc::XMLFormatTarget& ft,
            const ::FilterCpu& x, 
            const ::xml_schema::NamespaceInfomap& m = ::xml_schema::NamespaceInfomap (),
            const ::std::string& e = "UTF-8",
            ::xml_schema::Flags f = 0);
 ...
 */
void
FilterCpu_ (::xercesc::DOMDocument& d,
            const ::FilterCpu& x,
            ::xml_schema::Flags f = 0);
...
#endif // CXX_HOME_KIPER220_GITHUB_KIPER220_ALT_GPUI_SRC_PLUGINS_PREFERENCES_ITEM_LEVEL_TARGETING_SCHEMAS_CPUSCHEMA_H
