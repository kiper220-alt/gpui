...
/**
 * @file
 * @brief Generated from msischema.xsd.
 */

#ifndef CXX_HOME_KIPER220_GITHUB_KIPER220_ALT_GPUI_SRC_PLUGINS_PREFERENCES_ITEM_LEVEL_TARGETING_SCHEMAS_MSISCHEMA_H
#define CXX_HOME_KIPER220_GITHUB_KIPER220_ALT_GPUI_SRC_PLUGINS_PREFERENCES_ITEM_LEVEL_TARGETING_SCHEMAS_MSISCHEMA_H
...
/**
 * @name Parsing functions for the %FilterMsi document root.
 */
//@{
...
FilterMsi_ (const ::std::string& uri,
            ::xml_schema::Flags f = 0,
 ...
 */
::std::unique_ptr< ::FilterMsi >
FilterMsi_ (::xercesc::InputSource& is,
            ::xml_schema::Flags f = 0,
            const ::xml_schema::Properties& p = ::xml_schema::Properties ());
 ...
 */
::std::unique_ptr< ::FilterMsi >
FilterMsi_ (const ::xercesc::DOMDocument& d,
            ::xml_schema::Flags f = 0,
            const ::xml_schema::Properties& p = ::xml_schema::Properties ());
...
/**
 * @name Serialization functions for the %FilterMsi document root.
 */
//@{
 ...
 */
void
FilterMsi_ (::xercesc::XMLFormatTarget& ft,
            const ::FilterMsi& x, 
            const ::xml_schema::NamespaceInfomap& m = ::xml_schema::NamespaceInfomap (),
            const ::std::string& e = "UTF-8",
            ::xml_schema::Flags f = 0);
...
#endif // CXX_HOME_KIPER220_GITHUB_KIPER220_ALT_GPUI_SRC_PLUGINS_PREFERENCES_ITEM_LEVEL_TARGETING_SCHEMAS_MSISCHEMA_H
