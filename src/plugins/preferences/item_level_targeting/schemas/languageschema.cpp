...
FilterLanguage_ (const ::std::string& u,
                 ::xml_schema::Flags f,
                 const ::xml_schema::Properties& p)
{
  ...
  return ::std::unique_ptr< ::FilterLanguage > (
    ::FilterLanguage_ (
                 ...
                 const ::xml_schema::Properties& p)
{
  ...
  return ::FilterLanguage_ (isrc, f, p);
}
                 ...
                 const ::xml_schema::Properties& p)
{
  ...
  ::xsd::cxx::xml::sax::std_input_source isrc (is);
  return ::FilterLanguage_ (isrc, h, f, p);
}
...
::std::unique_ptr< ::FilterLanguage >
FilterLanguage_ (::xercesc::InputSource& i,
                 ::xml_schema::Flags f,
                 const ::xml_schema::Properties& p)
{
  ::xsd::cxx::tree::error_handler< char > h;
...
::std::unique_ptr< ::FilterLanguage >
FilterLanguage_ (const ::xercesc::DOMDocument& doc,
                 ::xml_schema::Flags f,
                 const ::xml_schema::Properties& p)
{
  ...
  if (n.name () == "FilterLanguage" &&
      n.namespace_ () == "")
  {
    ::std::unique_ptr< ::FilterLanguage > r (
      ::xsd::cxx::tree::traits< ::FilterLanguage, char >::create (
        e, f, 0));
    return r;
  }
...
void
FilterLanguage_ (::std::ostream& o,
                 const ::FilterLanguage& s,
...
void
FilterLanguage_ (::xercesc::XMLFormatTarget& t,
                 const ::FilterLanguage& s,
                 const ::xml_schema::NamespaceInfomap& m,
                 const ::std::string& e,
                 ::xml_schema::Flags f)
...
FilterLanguage_ (const ::FilterLanguage& s,
                 const ::xml_schema::NamespaceInfomap& m,
                 ::xml_schema::Flags f)
{
  ::xml_schema::dom::unique_ptr< ::xercesc::DOMDocument > d (
