...
/**
 * @file
 * @brief Generated from processingschema.xsd.
 */

#ifndef CXX_HOME_KIPER220_GITHUB_KIPER220_ALT_GPUI_SRC_PLUGINS_PREFERENCES_ITEM_LEVEL_TARGETING_SCHEMAS_PROCESSINGSCHEMA_H
#define CXX_HOME_KIPER220_GITHUB_KIPER220_ALT_GPUI_SRC_PLUGINS_PREFERENCES_ITEM_LEVEL_TARGETING_SCHEMAS_PROCESSINGSCHEMA_H
...
class FilterProcMode: public ::IFilter
{
   ...
   * @name syncFore
   *
   * @brief Accessor and modifier functions for the %syncFore
   ...
   * @brief Attribute type.
   */
  typedef ::EnumTrueFalse SyncForeType;

  /**
   * @brief Attribute traits type.
   */
  typedef ::xsd::cxx::tree::traits< SyncForeType, char > SyncForeTraits;
   ...
   */
  void
  syncFore (::std::unique_ptr< SyncForeType > p);
   ...
   * @name asyncFore
   *
   * @brief Accessor and modifier functions for the %asyncFore
   * optional attribute with a default value.
   */
  //@{
   ...
   * @brief Attribute type.
   */
  typedef ::EnumTrueFalse AsyncForeType;

  /**
   * @brief Attribute traits type.
   */
  typedef ::xsd::cxx::tree::traits< AsyncForeType, char > AsyncForeTraits;
   ...
   */
  void
  asyncFore (::std::unique_ptr< AsyncForeType > p);
  ...
  protected:
  ::xsd::cxx::tree::one< SyncForeType > syncFore_;
  static const SyncForeType syncFore_default_value_;
  ::xsd::cxx::tree::one< AsyncForeType > asyncFore_;
  static const AsyncForeType asyncFore_default_value_;
...
/**
 * @name Parsing functions for the %FilterProcMode document root.
 */
//@{
...
FilterProcMode_ (const ::std::string& uri,
                 ::xml_schema::Flags f = 0,
 ...
 */
::std::unique_ptr< ::FilterProcMode >
FilterProcMode_ (::xercesc::InputSource& is,
                 ::xml_schema::Flags f = 0,
                 const ::xml_schema::Properties& p = ::xml_schema::Properties ());
 ...
 */
::std::unique_ptr< ::FilterProcMode >
FilterProcMode_ (const ::xercesc::DOMDocument& d,
                 ::xml_schema::Flags f = 0,
                 const ::xml_schema::Properties& p = ::xml_schema::Properties ());
...
/**
 * @name Serialization functions for the %FilterProcMode document root.
 */
//@{
 ...
 */
void
FilterProcMode_ (::std::ostream& os,
                 const ::FilterProcMode& x, 
 ...
 */
void
FilterProcMode_ (::xercesc::XMLFormatTarget& ft,
                 const ::FilterProcMode& x, 
                 const ::xml_schema::NamespaceInfomap& m = ::xml_schema::NamespaceInfomap (),
                 const ::std::string& e = "UTF-8",
                 ::xml_schema::Flags f = 0);
...
FilterProcMode_ (const ::FilterProcMode& x, 
                 const ::xml_schema::NamespaceInfomap& m = ::xml_schema::NamespaceInfomap (),
                 ::xml_schema::Flags f = 0);
...
#endif // CXX_HOME_KIPER220_GITHUB_KIPER220_ALT_GPUI_SRC_PLUGINS_PREFERENCES_ITEM_LEVEL_TARGETING_SCHEMAS_PROCESSINGSCHEMA_H
