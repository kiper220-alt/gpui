...
FilterDomain_ (const ::std::string& u,
               ::xml_schema::Flags f,
               const ::xml_schema::Properties& p)
{
  ...
  return ::std::unique_ptr< ::FilterDomain > (
    ::FilterDomain_ (
               ...
               const ::xml_schema::Properties& p)
{
  ...
  ::xsd::cxx::xml::sax::std_input_source isrc (is);
  return ::FilterDomain_ (isrc, h, f, p);
}
...
::std::unique_ptr< ::FilterDomain >
FilterDomain_ (::xercesc::InputSource& i,
               ::xml_schema::Flags f,
               const ::xml_schema::Properties& p)
{
  ::xsd::cxx::tree::error_handler< char > h;
...
::std::unique_ptr< ::FilterDomain >
FilterDomain_ (const ::xercesc::DOMDocument& doc,
               ::xml_schema::Flags f,
               const ::xml_schema::Properties& p)
{
  ...
  if (n.name () == "FilterDomain" &&
      n.namespace_ () == "")
  {
    ::std::unique_ptr< ::FilterDomain > r (
      ::xsd::cxx::tree::traits< ::FilterDomain, char >::create (
        e, f, 0));
    return r;
  }
...
void
FilterDomain_ (::std::ostream& o,
               const ::FilterDomain& s,
...
void
FilterDomain_ (::xercesc::XMLFormatTarget& t,
               const ::FilterDomain& s,
               const ::xml_schema::NamespaceInfomap& m,
               const ::std::string& e,
               ::xml_schema::Flags f)
...
FilterDomain_ (const ::FilterDomain& s,
               const ::xml_schema::NamespaceInfomap& m,
               ::xml_schema::Flags f)
{
  ::xml_schema::dom::unique_ptr< ::xercesc::DOMDocument > d (
