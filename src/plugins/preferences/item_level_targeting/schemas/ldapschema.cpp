...
FilterLdap_ (const ::std::string& u,
             ::xml_schema::Flags f,
             const ::xml_schema::Properties& p)
{
  ...
  return ::std::unique_ptr< ::FilterLdap > (
    ::FilterLdap_ (
...
::std::unique_ptr< ::FilterLdap >
FilterLdap_ (::xercesc::InputSource& i,
             ::xml_schema::Flags f,
             const ::xml_schema::Properties& p)
{
  ::xsd::cxx::tree::error_handler< char > h;
...
::std::unique_ptr< ::FilterLdap >
FilterLdap_ (const ::xercesc::DOMDocument& doc,
             ::xml_schema::Flags f,
             const ::xml_schema::Properties& p)
{
  ...
  if (n.name () == "FilterLdap" &&
      n.namespace_ () == "")
  {
    ::std::unique_ptr< ::FilterLdap > r (
      ::xsd::cxx::tree::traits< ::FilterLdap, char >::create (
        e, f, 0));
    return r;
  }
...
void
FilterLdap_ (::xercesc::XMLFormatTarget& t,
             const ::FilterLdap& s,
             const ::xml_schema::NamespaceInfomap& m,
             const ::std::string& e,
             ::xml_schema::Flags f)
...
FilterLdap_ (const ::FilterLdap& s,
             const ::xml_schema::NamespaceInfomap& m,
             ::xml_schema::Flags f)
{
  ::xml_schema::dom::unique_ptr< ::xercesc::DOMDocument > d (
