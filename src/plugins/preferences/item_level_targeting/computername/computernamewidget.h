...
#ifndef GPUI_COMPUTER_NAME_FILTER_WIDGET_H
#define GPUI_COMPUTER_NAME_FILTER_WIDGET_H

#include "targetingfilterwidget.h"

QT_BEGIN_NAMESPACE
namespace Ui { class computerNameWidget; }
QT_END_NAMESPACE

namespace preferences
{

//! Editor for `<FilterComputer name=".." type="DNS|NETBIOS"/>`.
class ComputerNameFilterWidget : public TargetingFilterWidget
{
public:
    Q_OBJECT

public:
    explicit ComputerNameFilterWidget(QWidget *parent = nullptr);
    ~ComputerNameFilterWidget() override;

    QString xsdName() const override { return QStringLiteral("FilterComputer"); }
...
#endif // GPUI_COMPUTER_NAME_FILTER_WIDGET_H
