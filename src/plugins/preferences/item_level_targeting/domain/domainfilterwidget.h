...
#ifndef GPUI_DOMAIN_FILTER_WIDGET_H
#define GPUI_DOMAIN_FILTER_WIDGET_H

#include "targetingfilterwidget.h"

QT_BEGIN_NAMESPACE
namespace Ui { class DomainWidget; }
QT_END_NAMESPACE

namespace preferences
{

//! Editor for `<FilterDomain name=".." userContext="0|1"/>`.
class DomainFilterWidget : public TargetingFilterWidget
{
public:
    Q_OBJECT

public:
    explicit DomainFilterWidget(QWidget *parent = nullptr);
    ~DomainFilterWidget() override;

    QString xsdName() const override { return QStringLiteral("FilterDomain"); }
...
#endif // GPUI_DOMAIN_FILTER_WIDGET_H
